...
<form action="signup-2.jsp">
 ...
 信箱:<input type="email" name="email"  required><br><br><br>
 ...
 再次輸入密碼:<input type="password" name="psw2" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" required><br><br><br>
